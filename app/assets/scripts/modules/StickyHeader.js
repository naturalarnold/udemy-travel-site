...
class StickyHeader {
    constructor () {
        ...
        this.previousScrollY = window.scrollY;this.pageSections[0]
        this.events();
    }
    ...
    calcSection(elem) {
        if(window.scrollY + this.browserHeight > elem.offsetTop && window.scrollY < elem.offsetTop + elem.offsetHeight) {
            let scrollPercent = elem.getBoundingClientRect().y / this.browserHeight * 100;
            if (elem.isFirstSection && scrollPercent > 20 && this.scrollDirection == 'up') {
            ...
            } else if ((scrollPercent < 25 && scrollPercent > -0.1 && this.scrollDirection == 'down') || (scrollPercent < 33 && this.scrollDirection == 'up')) {
                let matchingLink = elem.getAttribute("data-matching-link");
